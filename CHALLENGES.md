...
### Challenge 1.1 — First Query ⏱️ ~20 min
...
### Challenge 1.2 — JOINs and Filters ⏱️ ~25 min
...
### Challenge 1.3 — Window Functions ⏱️ ~35 min
...
### Challenge 1.4 — CTEs and Dedupe ⏱️ ~30 min
...
### Challenge 2.1 — Load and Validate ⏱️ ~30 min
...
### Challenge 2.2 — Transform (pandas) ⏱️ ~40 min
...
### Challenge 2.3 — Idempotent Load ⏱️ ~45 min
...
### Challenge 3.1 — Star Schema on Paper ⏱️ ~30 min
...
### Challenge 3.2 — First dbt Models ⏱️ ~45 min
...
### Challenge 3.3 — SCD Type 2 (Concept) ⏱️ ~25 min
...
### Challenge 3.4 — Data Quality Tests ⏱️ ~30 min
...
### Challenge 4.1 — Cost Checklist ⏱️ ~20 min
...
### Challenge 4.2 — Partitioning Design ⏱️ ~30 min
...
### Challenge 4.3 — Airflow / Cron DAG (Concept) ⏱️ ~40 min
...
### Challenge 4.4 — Backfill Scenario ⏱️ ~25 min
...
### Challenge 5.1 — SQL Live (45 min timer) ⏱️
...
### Challenge 5.2 — Python Live ⏱️ ~45 min
...
### Challenge 5.3 — Data Modeling Case ⏱️ ~60 min
...
### Challenge 5.4 — Explain Your Pipeline ⏱️ ~30 min
...
### Bonus 1 — End-to-End Pet Project ⏱️ ~8–12 hours (split across weeks)
...
### Bonus 2 — Senior AE Prep ⏱️ ~4 hours

**Quest**: Work through [`interview-sprint/04-Senior-AE-Additions.md`](interview-sprint/04-Senior-AE-Additions.md) — too early for Senior, but knowing the vocabulary helps.
